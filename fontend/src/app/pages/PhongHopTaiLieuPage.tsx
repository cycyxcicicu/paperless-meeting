...
import { PHIEN_HOP_SIDEBAR_ITEMS, PHONG_HOP_SIDEBAR_ITEMS } from "../constants/sidebar";
                    ...
                    <div className="mt-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                        ...
                        <div className="flex items-center gap-3">
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2.5 bg-[#C8102E] text-white rounded-xl text-sm font-medium hover:bg-[#A90F14] transition-all shadow-sm shadow-red-500/20"
                            >
                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-gray-50/80 border-b border-gray-100">
                                        <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider w-[60px]">
                                            STT
                                        </th>
                                        <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider w-[150px]">
                                            Mã TL
                                        </th>
                                        <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">
                                            Tên tài liệu
                                        </th>
                                        <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider w-[180px]">
                                            Người đăng
                                        </th>
                                        <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider w-[120px]">
                                            Ngày đăng
                                        </th>
                                        <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider text-right w-[100px]">
                                            Thao tác
                                        </th>
                                    </tr>
                                </thead>
                                        ...
                                        filteredData.map((doc, index) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4">
                                                    <span className="inline-flex px-2 py-1 bg-gray-100 text-gray-700 rounded text-xs font-mono font-medium">
                                                        {doc.code}
                                                    </span>
                                                </td>
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="flex flex-col">
                                                            <span className="text-sm font-bold text-gray-900 group-hover:text-[#C8102E] transition-colors line-clamp-1">
                                                                {doc.name}
                                                            </span>
                        ...
                        >
                            ...
                            <div className="px-6 py-4 border-t border-gray-100 flex justify-end gap-3 bg-gray-50/50">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 bg-[#C8102E] text-white rounded-xl text-sm font-semibold shadow-sm hover:bg-[#A90F14] transition-colors shadow-red-500/20"
                                >
                                    {isAddModalOpen
                                        ? "Lưu tài liệu"
                                        : "Cập nhật"}
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                        ...
                        >
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    onClick={() => setIsDeleteModalOpen(false)}
                                    className="flex-1 px-4 py-2.5 bg-[#C8102E] text-white rounded-xl text-sm font-semibold shadow-sm hover:bg-[#A90F14] transition-colors shadow-red-500/20"
                                >
                                    Xóa ngay
                                </button>
                            </div>
