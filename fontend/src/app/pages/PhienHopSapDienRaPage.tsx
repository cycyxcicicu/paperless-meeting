  ...
  const votingIssues = [
    {
      ...
      content: 'Nội dung 1',
      issue:
        'Phê duyệt Đề án phát triển hạ tầng giao thông khu vực phía Nam thành phố giai đoạn 2026-2030',
    ...
    },
    {
      ...
      content: 'Nội dung 2',
      issue:
        'Phê duyệt chủ trương đầu tư Dự án Trung tâm hành chính công tập trung',
      status: 'Chưa biểu quyết',
    },
  ];
      ...
      <main className="flex-1 ml-60 p-8">
        ...
        <div className="space-y-6">
          <Card className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="w-full text-center py-2">
                  ...
                  <div className="flex items-center justify-center gap-6 text-gray-600 text-[14px]">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span>Thời gian: 25/04/2026 14:00 - 16:00</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-12">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <span className="text-gray-900 font-medium w-1/2">-</span>
                    </div>
                    <div className="flex items-start justify-between">
                      <span className="text-gray-500 text-[14px] font-medium w-1/2">
                        Giấy mời họp:
            ...
            {/* Nội dung họp */}
            <CollapsibleSection title={`Nội dung họp (${meetingContents.length})`}>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="grid grid-cols-2 gap-x-8 gap-y-3 mb-4 text-sm">
                        ...
                        <div className="flex items-start">
                          ...
                          <span className="text-gray-900">{content.duration}</span>
                        </div>
                        <div className="flex items-start">
                          <span className="text-gray-500 font-medium mr-2">
                            Trạng thái nội dung:
            ...
            >
                  ...
                  <tbody>
                    {votingIssues.map((issue, index) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-4 text-gray-700">{issue.content}</td>
              ...
              <div className="flex items-center justify-end gap-2 mt-4 px-2">
                <span className="text-sm text-gray-600">
                  1-{votingIssues.length} của {votingIssues.length}
                </span>
