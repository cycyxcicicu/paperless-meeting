...
import { Clock, MapPin, Download, FileText, Upload, ArrowLeft } from 'lucide-react';
        ...
        <div className="space-y-6">
          <Card className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="w-full text-center py-2">
                  ...
                  <div className="flex items-center justify-center gap-6 text-gray-600 text-[14px]">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span>17/04/2026 22:31 - 23:20</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-12">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start justify-between">
                      <span className="text-gray-500 text-[14px] font-medium w-1/2">Chủ trì:</span>
                      <span className="text-gray-900 font-medium w-1/2">Ông Trần Văn A - Bí thư</span>
                    </div>
                    <div className="flex items-start justify-between">
                      <span className="text-gray-500 text-[14px] font-medium w-1/2">Địa điểm họp:</span>
                      <span className="text-gray-900 font-medium w-1/2">Phòng họp 1 demo</span>
                    </div>
                    <div className="flex items-start justify-between">
                      <span className="text-gray-500 text-[14px] font-medium w-1/2">Giấy mời họp:</span>
                      <span className="text-gray-900 w-1/2">-</span>
                    </div>
                    <div className="flex items-start justify-between">
                      <span className="text-gray-500 text-[14px] font-medium w-1/2">Kết luận phiên họp:</span>
                      <span className="text-gray-900 w-1/2">-</span>
                    </div>
                    <div className="flex items-start justify-between">
                      <span className="text-gray-500 text-[14px] font-medium w-1/2">Người chuẩn bị tài liệu:</span>
                      <span className="text-gray-900 font-medium w-1/2">Nguyễn Văn B</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    {status !== 'Đã kết thúc' && status !== 'Nháp' && (
                      <div className="flex items-start justify-between">
                        ...
                        <span className="text-[#C8102E] font-bold w-1/2">45 phút 12 giây</span>
                      </div>
                    )}
                    <div className="flex items-start justify-between">
                      <span className="text-gray-500 text-[14px] font-medium w-1/2">
                    ...
                    <div className="flex items-start justify-between">
                      <span className="text-gray-500 text-[14px] font-medium w-1/2">Chương trình họp:</span>
                      <span className="text-gray-900 w-1/2">-</span>
                    </div>
                    <div className="flex items-start justify-between">
                      <span className="text-gray-500 text-[14px] font-medium w-1/2">Trạng thái phiên họp:</span>
                      <div className="w-1/2">
                        <Badge
                          className={
                            status === 'Đang diễn ra'
                    ...
                    <div className="flex items-start justify-between">
                      <span className="text-gray-500 text-[14px] font-medium w-1/2">Người duyệt tài liệu:</span>
                      <span className="text-gray-900 font-medium w-1/2">Trần Văn C</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3 px-2">
                <div className="flex items-center justify-between p-3 rounded-lg border border-gray-100 hover:bg-gray-50 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900 text-sm">Báo cáo tình hình kinh tế - xã hội Quý 1.pdf</p>
                      <p className="text-xs text-gray-500">2.4 MB • Tải lên lúc 08:30 17/04</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 rounded-lg border border-gray-100 hover:bg-gray-50 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900 text-sm">Kế hoạch triển khai Quý 2 chi tiết.docx</p>
                      <p className="text-xs text-gray-500">1.1 MB • Tải lên lúc 08:45 17/04</p>
                    </div>
                  </div>
                  <Button variant="ghost" size="icon" className="text-gray-500 hover:text-[#C8102E]">
                    <Download className="w-4 h-4" />
                ...
                <table className="w-full text-left border-collapse text-sm">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-200">
                      ...
                      <th className="py-3 px-4 font-semibold text-gray-600">Vấn đề</th>
                      <th className="py-3 px-4 font-semibold text-gray-600 w-40">Trạng thái</th>
                      <th className="py-3 px-4 font-semibold text-gray-600 w-32 text-center">Hành động</th>
                    </tr>
                  </thead>
                </table>
              ...
              <div className="min-h-[200px] flex flex-col">
                <table className="w-full text-left border-collapse text-sm">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-200">
                      <th className="py-3 px-4 font-semibold text-gray-600 w-16 text-center">STT</th>
                      <th className="py-3 px-4 font-semibold text-gray-600">Tên đại biểu</th>
                      <th className="py-3 px-4 font-semibold text-gray-600">Chức vụ</th>
                      <th className="py-3 px-4 font-semibold text-gray-600">Ghi chú</th>
                      <th className="py-3 px-4 font-semibold text-gray-600">Thời gian bắt đầu phát biểu</th>
            ...
            <CollapsibleSection 
              ...
              action={
                <Button variant="outline" size="sm" className="h-8 gap-1.5 border-gray-200 text-gray-600">
                ...
                <table className="w-full text-left border-collapse text-sm">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-200">
                      ...
                      <th className="py-3 px-4 font-semibold text-gray-600">Tên đại biểu</th>
                      <th className="py-3 px-4 font-semibold text-gray-600">Chức vụ</th>
                      <th className="py-3 px-4 font-semibold text-gray-600">Chi tiết góp ý</th>
                      <th className="py-3 px-4 font-semibold text-gray-600 w-32 text-center">Hành động</th>
                    </tr>
                  </thead>
                </table>
