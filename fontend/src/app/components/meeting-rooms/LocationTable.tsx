              ...
              return (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col min-w-0">
                        ...
                        <code className="text-xs text-gray-400 font-medium">
                          {location.code}
                        </code>
                      </div>
                    </div>
                  ...
                  <td className="px-6 py-4 text-center">
                    <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-blue-50 text-blue-700 font-semibold text-sm">
