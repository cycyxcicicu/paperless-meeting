        ...
        >
          <div className="px-6 py-4">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-sm font-bold text-gray-900">Bộ lọc nâng cao</h3>
              {hasActiveFilters && (
                <button
                  onClick={onClearFilters}
                  className="text-xs font-semibold text-[#C8102E] hover:text-[#A90F14] transition-colors flex items-center gap-1"
                >
                  <X className="h-3 w-3" />
                  Xóa bộ lọc
                </button>
                ...
                <div className="flex flex-wrap gap-2">
                  {actionTypes.map((action) => (
                    <button
                      ...
                      className={cn(
                        'inline-flex items-center gap-2 px-3 py-1.5 text-xs font-semibold rounded-lg border transition-all',
