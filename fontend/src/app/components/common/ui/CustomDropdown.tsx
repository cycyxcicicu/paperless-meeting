  ...
  return (
    <div className={cn("relative", className)} ref={dropdownRef}>
      ...
      <button
        ...
        className={cn(
          "w-full h-10 pl-4 pr-10 text-sm border border-gray-300 rounded-xl bg-white text-gray-900 font-medium focus:outline-none focus:border-[#C8102E] focus:ring-2 focus:ring-[#C8102E]/20 cursor-pointer transition-all text-left flex items-center justify-between",
          buttonClassName
        )}
      >
