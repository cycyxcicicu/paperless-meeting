    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 animate-in fade-in-0 zoom-in-95 max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 flex-shrink-0 bg-white">
          <h3 className="text-lg font-semibold text-gray-900">Xác nhận tham gia</h3>
          <button
            onClick={handleClose}
              ...
              <div className="mt-6 space-y-4 pl-8 border-l-2 border-gray-200">
                ...
                {!isFullSession && (
                  <Button
                    ...
                    className="w-full border-[#C8102E] text-[#C8102E] hover:bg-red-50 rounded-lg h-10 font-medium"
                  >
        ...
        <div className="flex items-center justify-center gap-3 px-6 py-4 border-t border-gray-200 flex-shrink-0">
          <Button
            variant="outline"
            onClick={handleClose}
            className="px-6 py-2.5 border-gray-300 text-gray-700 hover:bg-gray-50 rounded-lg h-10 font-medium transition-all"
          >
            Hủy bỏ
          </Button>
          <Button
            ...
            className="px-6 py-2.5 bg-[#C8102E] hover:bg-[#a80d26] text-white rounded-lg h-10 font-medium transition-all"
          >
            Xác nhận
          </Button>
        </div>
