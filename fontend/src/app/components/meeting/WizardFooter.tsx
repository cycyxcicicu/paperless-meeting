          ...
          <div className="flex items-center gap-3">
            {currentStep === 1 ? (
              onCancel && (
                <button
                  onClick={onCancel}
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border-2 border-[#C8102E] text-[#C8102E] font-semibold text-sm hover:bg-red-50 transition-all"
                >
                  <X className="h-4 w-4" />
                  Hủy bỏ
                </button>
              ...
              <button
                onClick={onBack}
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-gray-300 text-gray-700 font-semibold text-sm hover:bg-gray-50 transition-all"
              >
          ...
          <div className="flex items-center gap-3">
            ...
            {!isUpdateMode && isLastStep && isPending && (
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-amber-50 border border-amber-200">
                ...
                <span className="text-sm font-semibold text-amber-700">Đang chờ phê duyệt</span>
              </div>
            )}
            ...
            {isLastStep ? (
              <>
                ...
                {!isUpdateMode && onSubmitForApproval && !isApproved && (
                  <button
                    ...
                    disabled={isPending}
                    className={cn(
                      'inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-gray-300 text-gray-700 font-semibold text-sm hover:bg-gray-50 transition-all',
                ...
                {onSubmitMeeting && (
                  <div className="relative group">
                    <button
                      ...
                      className={cn(
                        'inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#C8102E] to-[#A90F14] text-white font-semibold text-sm transition-all',
                        canSubmitMeeting
              ...
              <button
                onClick={onNext}
                className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-gradient-to-r from-[#C8102E] to-[#A90F14] text-white font-semibold text-sm hover:shadow-lg hover:shadow-red-500/25 transition-all"
              >
                Tiếp tục
              </button>
            )}
