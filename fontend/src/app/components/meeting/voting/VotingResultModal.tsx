    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-5xl mx-4 max-h-[90vh] flex flex-col animate-in fade-in-0 zoom-in-95">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 flex-shrink-0">
          <h3 className="text-lg font-semibold text-gray-900">Kết quả biểu quyết</h3>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-5">
            <p className="text-sm font-semibold text-gray-900">{issueTitle}</p>
          </div>
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  <tr className="border-b border-gray-200">
                    ...
                    <td className="py-3 px-3 text-center font-semibold">{results.agree}</td>
                  ...
                  <tr className="border-b border-gray-200">
                    ...
                    <td className="py-3 px-3 text-center font-semibold">{results.disagree}</td>
                    <td className="py-3 px-3 text-center font-semibold">
                  ...
                  <tr className="border-b border-gray-200">
                    ...
                    <td className="py-3 px-3 text-center font-semibold">{results.other}</td>
                    <td className="py-3 px-3 text-center font-semibold">
                  ...
                  <tr className="border-b border-gray-200">
                    ...
                    <td className="py-3 px-3 text-center font-semibold">{results.notVoted}</td>
                    <td className="py-3 px-3 text-center font-semibold">
                  ...
                  <table className="w-full text-left border-collapse text-sm">
                    <thead className="sticky top-0 bg-gray-50">
                      <tr className="border-b border-gray-200">
                        ...
                        <th className="py-3 px-4 font-semibold text-gray-600">Tên đơn vị</th>
                        <th className="py-3 px-4 font-semibold text-gray-600">
                          Phương án đã chọn
                        </th>
                      </tr>
                  ...
                  <table className="w-full text-left border-collapse text-sm">
                    <thead className="sticky top-0 bg-gray-50">
                      <tr className="border-b border-gray-200">
                        ...
                        <th className="py-3 px-4 font-semibold text-gray-600">Chức vụ</th>
                        <th className="py-3 px-4 font-semibold text-gray-600">Đơn vị</th>
                      </tr>
                    </thead>
                    <tbody>
