    ...
    const notifications = [
        {
            id: 1,
            title: "Cuộc họp mới",
            message: "Họp ban Thường vụ lúc 14:00",
            time: "5 phút trước",
            unread: true,
        },
        {
            id: 2,
            title: "Tài liệu mới",
            message: "Báo cáo tháng 4 đã được tải lên",
            time: "1 giờ trước",
            unread: true,
        },
        {
            ...
            <div className="h-full flex items-center justify-between px-6 gap-8">
                ...
                <div className="flex items-center gap-1 shrink-0">
                    ...
                    <button className="relative group p-2.5 rounded-lg text-gray-400 hover:text-gray-700 hover:bg-gray-50 transition-all duration-200">
                        ...
                        <span className="absolute -bottom-10 left-1/2 -translate-x-1/2 px-2 py-1 bg-gray-900 text-white text-[10px] btn-primary rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
                            Trợ giúp
                        </span>
                    </button>
                            ...
                            {showNotifications && (
                                ...
                                >
                                    ...
                                    <div className="p-3 border-t border-gray-100 bg-gray-50">
                                        <button className="w-full text-xs btn-primary text-[#C8102E] hover:text-[#A90F14] transition-colors">
                        ...
                        <AnimatePresence>
                            {showUserMenu && (
                                ...
                                >
                                    ...
                                    {/* Menu Items */}
                                    <div className="p-2">
                                        <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm body text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition-all group">
                                            <UserCircle
                                        ...
                                        <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm body text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition-all group">
                                            ...
                                            />
                                            <span>Tin nhắn</span>
                                            <span className="ml-auto text-[10px] heading bg-red-500 text-white px-1.5 py-0.5 rounded-full">
                                                3
                                            </span>
                                        </button>
                                        <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm body text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition-all group">
                                    ...
                                    {/* Logout */}
                                    <div className="p-2">
                                        <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm btn-primary text-red-600 hover:bg-red-50 transition-all group">
                                            <LogOut
                                                className="h-4 w-4"
                                                strokeWidth={2.5}
                                            />
