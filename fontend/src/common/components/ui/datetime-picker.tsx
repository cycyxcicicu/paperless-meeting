        ...
        >
          <div className="flex">
            ...
            <div className="p-3 border-r border-gray-200">
              <DayPicker
                ...
                classNames={{
                  ...
                  caption_label: 'text-sm btn-primary text-gray-700',
                  ...
                  head_row: 'flex',
                  head_cell: 'text-gray-500 rounded-md w-9 btn-primary text-[0.75rem] uppercase',
                  row: 'flex w-full mt-2',
                  cell: 'h-9 w-9 text-center text-sm p-0 relative',
                  day: 'h-9 w-9 p-0 body rounded-lg hover:bg-gray-100 transition-all cursor-pointer',
                  day_selected: 'bg-[#C8102E] text-white hover:bg-[#A90F14] hover:text-white focus:bg-[#C8102E] focus:text-white heading shadow-md ring-2 ring-[#C8102E]/30 ring-offset-1',
                  day_today: 'bg-blue-50 text-blue-700 btn-primary border border-blue-200',
            ...
            <div className="w-48 p-3 flex flex-col bg-gray-50/50">
              <div className="text-sm btn-primary text-gray-700 mb-3 text-center">
                Chọn giờ
              </div>
              ...
              <div className="flex gap-2 flex-1">
                ...
                <div className="flex-1">
                  <div className="text-xs text-gray-500 text-center mb-1.5 body">Giờ</div>
                    ...
                    {hours.map((hour) => (
                      <button
                        ...
                        className={cn(
                          ...
                          selectedHour === hour
                            ? 'bg-[#C8102E] text-white heading shadow-sm'
                            : 'hover:bg-gray-100 text-gray-700 body'
                        )}
                      >
                ...
                {/* Minutes */}
                <div className="flex-1">
                  <div className="text-xs text-gray-500 text-center mb-1.5 body">Phút</div>
                ...
                {/* AM/PM */}
                <div className="w-16">
                  <div className="text-xs text-gray-500 text-center mb-1.5 body">&nbsp;</div>
                  <div className="flex flex-col gap-2">
                    <button
                      type="button"
                      onClick={() => handlePeriodChange('AM')}
                      className={cn(
                        'px-2 py-2 text-sm text-center rounded-lg transition-all btn-primary',
                        selectedPeriod === 'AM'
          ...
          <div className="border-t border-gray-200 px-4 py-3 flex justify-between items-center bg-gray-50">
            <div className="flex gap-2">
              <button
                type="button"
                onClick={handleClear}
                className="px-3 py-1.5 text-sm text-gray-600 hover:text-gray-800 hover:bg-white rounded-lg transition-all body border border-transparent hover:border-gray-300"
              >
                Xóa
              </button>
              <button
            ...
            <button
              ...
              className="px-4 py-1.5 text-sm text-white bg-[#C8102E] hover:bg-[#A90F14] rounded-lg transition-all btn-primary shadow-sm hover:shadow"
            >
              Xong
            </button>
          </div>
