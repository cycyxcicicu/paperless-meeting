    ...
    <div className="p-6 border-b border-gray-200/60 sticky top-0 z-20 backdrop-blur-sm bg-white/95">
      <div className="flex flex-wrap items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <button 
            onClick={onExport}
            className="inline-flex items-center gap-2 h-12 px-5 py-2.5 text-sm btn-primary text-gray-700 bg-white border border-gray-200 rounded-2xl hover:border-gray-300 hover:bg-gray-50 hover:shadow-sm transition-all group"
          >
          ...
          <button 
            onClick={onAddNew}
            className="inline-flex items-center gap-2 h-12 px-6 py-2.5 bg-gradient-to-r from-[#C8102E] to-[#A90F14] text-white text-sm heading rounded-2xl shadow-md hover:shadow-xl hover:translate-y-[-2px] transition-all active:scale-95 group"
          >
