  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center justify-between relative z-10">
        <div>
          <p className="text-sm body text-gray-500 mb-1">{label}</p>
          <div className="flex items-baseline gap-2">
            <p className="text-3xl heading text-gray-900 tracking-tight">{value}</p>
            {description && <span className="text-xs text-gray-400 caption">{description}</span>}
          </div>
        </div>
        <div className={cn(
