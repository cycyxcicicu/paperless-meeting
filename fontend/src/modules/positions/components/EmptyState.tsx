    ...
    <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
      ...
      >
        ...
        <div className="absolute -top-2 -right-2 w-10 h-10 rounded-full bg-red-50 flex items-center justify-center border border-red-100 animate-bounce shadow-sm">
          <span className="text-red-500 heading text-xl">?</span>
        </div>
      </motion.div>
      ...
      >
        <h3 className="text-xl heading text-gray-900 mb-2">
        ...
        <div className="flex items-center justify-center gap-3">
          {type === 'search' ? (
            <button
              onClick={onReset}
              className="inline-flex items-center gap-2 px-6 py-2.5 bg-white border border-gray-200 text-gray-700 text-sm heading rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all active:scale-95 shadow-sm"
            >
            ...
            <button
              onClick={onAdd}
              className="inline-flex items-center gap-2 px-8 py-3 bg-[#C8102E] text-white text-sm heading rounded-xl hover:bg-[#A90F14] shadow-lg shadow-red-200 transition-all active:scale-95"
            >
