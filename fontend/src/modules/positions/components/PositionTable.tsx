      ...
      <table className="w-full border-separate border-spacing-y-2 px-6">
        <thead className="sticky top-0 z-10 bg-white/80 backdrop-blur-sm">
          <tr className="text-left">
            ...
            <th className="px-4 py-3 text-xs heading text-gray-400 uppercase tracking-widest flex items-center gap-1.5">
              <Hash className="h-3 w-3" />
              STT
            </th>
            <th className="px-4 py-3 text-xs heading text-gray-400 uppercase tracking-widest">
              Thông tin chức vụ
            </th>
            <th className="px-4 py-3 text-xs heading text-gray-400 uppercase tracking-widest text-center">
              Số nhân sự
            </th>
            ...
            return (
              ...
              >
                ...
                <td className={cn(
                  ...
                  <span className="text-sm heading text-gray-400 font-mono">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col min-w-0">
                      <div className="flex items-center gap-2 mb-0.5">
                        ...
                        <code className="text-[10px] heading px-1.5 py-0.5 bg-gray-100 text-gray-500 rounded uppercase tracking-wider shrink-0 border border-gray-200/50">
                          {position.code}
                        </code>
                      </div>
                ...
                <td className={cn(
                  ...
                  <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-blue-50/50 border border-blue-100 text-blue-700 heading text-sm shadow-sm transition-transform hover:scale-105">
