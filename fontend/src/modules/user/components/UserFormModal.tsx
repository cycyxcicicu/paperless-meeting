  ...
  return (
    ...
    >
      <FormProvider {...methods}>
        <form onSubmit={methods.handleSubmit(onFormSubmit)} className="space-y-6 pt-4" autoComplete="off">
          {/* Avatar Upload */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <FormInput name="username" label="Tên đăng nhập" required disabled={isViewMode} autoComplete="nope" />
            {isCreateMode && (
              <FormInput name="password" label="Mật khẩu" type="password" required disabled={isViewMode} autoComplete="new-password" />
            )}
            ...
            <FormSelect name="department" label="Đơn vị" options={departmentOptions} placeholder="Chọn đơn vị" required disabled={isViewMode} />
            <FormSelect name="position" label="Chức vụ" options={positionOptions} placeholder="Chọn chức vụ" required disabled={isViewMode} />
