    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-4 animate-in fade-in-0 zoom-in-95">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg btn-primary text-gray-900">{issueTitle}</h3>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <p className="text-2xl heading text-blue-600 font-mono">
                {formatTime(timeLeft)}
              </p>
            </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-base btn-primary text-gray-900">Đồng ý</p>
                  </div>
                </div>
                <input
                  type="radio"
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-base btn-primary text-gray-900">
                      Không đồng ý
                    </p>
                  </div>
                </div>
            ...
            <div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-base btn-primary text-gray-900">Ý kiến khác</p>
                    </div>
                  </div>
                  <input
                    type="radio"
              ...
              {selectedOption === 'other' && (
                <div className="mt-3 animate-in fade-in-0 slide-in-from-top-2">
                  ...
                  />
                  {error && selectedOption === 'other' && (
                    <p className="text-xs text-red-600 body mt-1">{error}</p>
                  )}
                </div>
              )}
            </div>
          ...
          {error && selectedOption !== 'other' && (
            <p className="text-sm text-red-600 body text-center">{error}</p>
          )}
        </div>
