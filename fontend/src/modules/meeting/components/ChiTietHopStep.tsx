    ...
    <div className="grid grid-cols-[58%_42%] gap-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          />
          {errors.tenPhienHop && (
            <p className="text-xs text-red-600 body mt-1">{errors.tenPhienHop}</p>
          )}
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1.5">
            ...
            {errors.thoiGianBatDau && (
              <p className="text-xs text-red-600 body mt-1">{errors.thoiGianBatDau}</p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            {errors.thoiGianKetThuc && (
              <p className="text-xs text-red-600 body mt-1">{errors.thoiGianKetThuc}</p>
            )}
          </div>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          />
          {errors.diaDiem && (
            <p className="text-xs text-red-600 body mt-1">{errors.diaDiem}</p>
          )}
        </div>
        ...
        <div className="border border-gray-400 rounded-xl overflow-hidden hover:border-gray-500 transition-colors">
          ...
          >
            <span className="text-sm btn-primary text-gray-700 flex-1">Rút gọn thông tin</span>
            {isCollapsed ? (
