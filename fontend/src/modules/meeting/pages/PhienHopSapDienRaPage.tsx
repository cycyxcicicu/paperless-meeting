                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-12">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-start justify-between">
                                            ...
                                            <button className="text-blue-600 hover:text-blue-800 underline w-1/2 text-left text-[14px] body focus:outline-none">
                                        ...
                                        <CardContent className="p-6">
                                            ...
                                            <div className="flex items-start justify-between mb-4">
                                                <div className="flex-1">
                                                    <h3 className="text-base heading text-gray-900 mb-2">
                                                        {content.title}
                                                    </h3>
                                            ...
                                            <div className="grid grid-cols-2 gap-x-8 gap-y-3 mb-4 text-sm">
                                                <div className="flex items-start">
                                                    <span className="text-gray-500 body mr-2">
                                                ...
                                                <div className="flex items-start">
                                                    ...
                                                    <button className="text-blue-600 hover:text-blue-800 underline text-sm body focus:outline-none">
                                                        Xem thành phần tham gia
                                                    </button>
                                                </div>
                                                <div className="flex items-start">
                                            ...
                                            {/* Danh sách tài liệu */}
                                            <div>
                                                <p className="text-sm btn-primary text-gray-700 mb-3">
                                                    Danh sách tài liệu:
                                                </p>
                                ...
                                <table className="w-full text-left border-collapse text-sm">
                                    <thead>
                                        <tr className="bg-gray-50 border-b border-gray-200">
                                            ...
                                            <th className="py-3 px-4 btn-primary text-gray-600 w-32">
                                                Nội dung
                                            </th>
                                            <th className="py-3 px-4 btn-primary text-gray-600">
                                                Vấn đề
                                            </th>
                                            <th className="py-3 px-4 btn-primary text-gray-600 w-40">
                                                Trạng thái
                                            </th>
