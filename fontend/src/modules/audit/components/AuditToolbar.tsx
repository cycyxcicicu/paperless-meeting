    ...
    <div className="bg-white border-b border-gray-200 px-6 py-4">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          className={cn(
            'inline-flex items-center gap-2 h-10 px-4 text-sm btn-primary rounded-lg transition-all relative',
            showFilters
        ...
        >
          ...
          {activeFiltersCount > 0 && (
            <span className={cn(
              'w-5 h-5 text-[10px] heading rounded-full flex items-center justify-center',
        ...
        {/* Date Range Button */}
        <button className="inline-flex items-center gap-2 h-10 px-4 text-sm body text-gray-700 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 hover:border-gray-300 transition-all">
        ...
        <button
          onClick={onExport}
          className="inline-flex items-center gap-2 h-10 px-4 text-sm body text-gray-700 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 hover:border-gray-300 transition-all"
        >
