    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl mx-4 animate-in fade-in-0 zoom-in-95 max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 flex-shrink-0">
          <h3 className="text-lg btn-primary text-gray-900">{getModalTitle()}</h3>
          <button
            onClick={handleClose}
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="space-y-2">
                  <Label htmlFor="name" className="text-sm body text-gray-700">
                  ...
                  />
                  {errors.name && (
                    <p className="text-xs text-red-600 body">{errors.name}</p>
                  )}
                </div>

                {/* Code */}
                <div className="space-y-2">
                  <Label htmlFor="code" className="text-sm body text-gray-700">
                  ...
                  />
                  {errors.code && (
                    <p className="text-xs text-red-600 body">{errors.code}</p>
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                {/* Type */}
                <div className="space-y-2">
                  <Label htmlFor="type" className="text-sm body text-gray-700">
                  ...
                  />
                  {errors.type && (
                    <p className="text-xs text-red-600 body">{errors.type}</p>
                  )}
                </div>

                {/* Department */}
                <div className="space-y-2">
                  <Label htmlFor="department" className="text-sm body text-gray-700">
                  ...
                  />
                  {errors.departmentId && (
                    <p className="text-xs text-red-600 body">{errors.departmentId}</p>
                  )}
                </div>
              </div>
              ...
              {showCapacity && (
                <div className="space-y-2">
                  <Label htmlFor="capacity" className="text-sm body text-gray-700">
                  ...
                  />
                  {errors.capacity && (
                    <p className="text-xs text-red-600 body">{errors.capacity}</p>
                  )}
                </div>
              )}
              ...
              {showAddress && (
                <div className="space-y-2">
                  <Label htmlFor="address" className="text-sm body text-gray-700">
                  ...
                  />
                  {errors.address && (
                    <p className="text-xs text-red-600 body">{errors.address}</p>
                  )}
                </div>
              )}
              ...
              {showOnlineLink && (
                <div className="space-y-2">
                  <Label htmlFor="onlineLink" className="text-sm body text-gray-700">
                  ...
                  />
                  {errors.onlineLink && (
                    <p className="text-xs text-red-600 body">{errors.onlineLink}</p>
                  )}
                </div>
              )}
            </div>
