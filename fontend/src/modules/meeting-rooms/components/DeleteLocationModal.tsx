      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 animate-in fade-in-0 zoom-in-95">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg btn-primary text-gray-900">Xác nhận xóa địa điểm</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-5">
          ...
          <div className="bg-red-50 border border-red-200 rounded-xl p-4 space-y-2">
            <div className="flex items-start gap-2">
              <span className="text-xs btn-primary text-gray-600 min-w-[80px]">Tên phòng:</span>
              <span className="text-sm btn-primary text-gray-900">{location.name}</span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-xs btn-primary text-gray-600 min-w-[80px]">Mã phòng:</span>
              <code className="text-sm font-mono text-gray-900 bg-white px-2 py-0.5 rounded border border-red-200">{location.code}</code>
            </div>
            {location.type && (
              <div className="flex items-start gap-2">
                <span className="text-xs btn-primary text-gray-600 min-w-[80px]">Loại:</span>
