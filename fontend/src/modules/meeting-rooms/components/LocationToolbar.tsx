    ...
    <div className="bg-white border-b border-gray-100 px-6 py-4">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={onExport}
            className="inline-flex items-center gap-2 h-11 px-4 text-sm body text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all active:scale-95"
          >
          ...
          <button
            onClick={onAddNew}
            className="inline-flex items-center gap-2 h-11 px-5 bg-[#C8102E] text-white text-sm heading rounded-xl shadow-md hover:shadow-lg hover:bg-[#A90F14] transition-all active:scale-95 group"
          >
