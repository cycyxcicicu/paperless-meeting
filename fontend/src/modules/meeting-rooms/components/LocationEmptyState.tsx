      ...
      >
        ...
        <div className="flex items-center justify-center gap-3">
          {type === 'search' ? (
            <button
              onClick={onReset}
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-white border border-gray-200 text-gray-700 text-sm btn-primary rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all active:scale-95 shadow-sm"
            >
            ...
            <button
              onClick={onAdd}
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#C8102E] text-white text-sm heading rounded-xl hover:bg-[#A90F14] shadow-lg shadow-red-200/50 transition-all active:scale-95"
            >
