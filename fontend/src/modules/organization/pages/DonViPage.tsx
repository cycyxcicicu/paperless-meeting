...
import {
  Sidebar,
  SidebarItem,
} from '@/common/components/layout/Sidebar';
                ...
                <div>
                  <p className="text-sm text-gray-600 mb-1">
                    ...
                    {activeFiltersCount > 0 && (
                      <span className="ml-2 text-xs text-blue-600 btn-primary">
                        (Đã lọc)
                      </span>
                    )}
                  </p>
                  <p className="text-3xl heading text-gray-900">
                    {totalItems}
                  </p>
                </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200/60 p-5 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl heading text-emerald-600">
                    {activeUnits}
                  </p>
                </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200/60 p-5 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg btn-primary text-gray-900 truncate">
